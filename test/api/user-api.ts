...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updateUser: async (user: User, username: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'user' is not null or undefined
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updateUser(user: User, username: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateUser(user, username, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateUser(user: User, username: string, options?: any): AxiosPromise<void> {
            return localVarFp.updateUser(user, username, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public updateUser(user: User, username: string, options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).updateUser(user, username, options).then((request) => request(this.axios, this.basePath));
    }
}
